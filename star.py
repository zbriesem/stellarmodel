...
class Star:
    ...
    def center(self):
        ...
        """
        ivec = load1.center_vec(self.Pc, self.Tc, self.L, self.M * 1e-6, self.ks, coreconv=self.coreconv)
        m = [self.M * 1e-6, self.fp]

        self.coutvecs, self.chs = integration.integrate(derivs.total_der, m, ivec, self.M * 1e-10, args=(self.ks,))
    ...
    def surface(self):
        ...
        self.soutvecs, self.shs = integration.integrate(derivs.total_der, m, ivec, -1. * self.M * 1e-10, args=(self.ks,))
