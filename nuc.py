...
def psi(T, Y):
    ...
    T7 = T / 1e7
    Yvals = [.1, .5, .9]
    T7vals = np.arange(.5, 3.75, .25)
    Psivals = np.array([[1., 1., 1., 1.03, 1.05, 1.15, 1.25, 1.36, 1.4, 1.42, 1.43, 1.43, 1.43], [1., 1., 1.03, 1.1, 1.36, 1.67,1.78, 1.65, 1.58, 1.50, 1.44, 1.43, 1.43], [1., 1., 1.17, 1.63, 1.84, 1.94, 1.93, 1.8, 1.69, 1.58, 1.5, 1.43, 1.43]])
